...
import sys
from FishEyeMonitoring import Ui_Widget
...
"}")
        ...
        self.widget.setGeometry(QRect(422, 405, 397, 46))
        self.FCFV_FirstZoneOperationField = QGridLayout(self.widget)
        ...
        self.FCFV_FZOF_LineYAxisOperationSeparator = QFrame(self.widget)
        ...
        self.FCFV_FZOF_SecondModeRadioButton = QRadioButton(self.widget)
...
"}")
        ...
        self.FCFV_FZOF_FirstModeRadioButton = QRadioButton(self.widget)
...
"}")
        ...
        self.FCFV_FZOF_BetaLabel = QLabel(self.widget)
        ...
        self.FCFV_FZOF_RotateLabel = QLabel(self.widget)
        ...
        self.FCFV_FZOF_AlphaSpinBox = QSpinBox(self.widget)
        ...
        self.FCFV_FZOF_ZoomInOutLabel = QLabel(self.widget)
        ...
        self.FCFV_FZOF_AlphaLabel = QLabel(self.widget)
        ...
        self.FCFV_FZOF_BetaSpinBox = QSpinBox(self.widget)
        ...
        self.FCFV_FZOF_ZoomInOutSpinBox = QDoubleSpinBox(self.widget)
        ...
        self.FCFV_FZOF_RotateSpinBox = QSpinBox(self.widget)
        ...
        self.widget1.setGeometry(QRect(825, 406, 397, 46))
        self.FCFV_SecondZoneOperationField = QGridLayout(self.widget1)
        ...
        self.FCFV_SZOF_BetaSpinBox = QSpinBox(self.widget1)
        ...
        self.FCFV_SZOF_ZoomInOutSpinBox = QDoubleSpinBox(self.widget1)
        ...
        self.FCFV_SZOF_AlphaSpinBox = QSpinBox(self.widget1)
        ...
        self.FCFV_SZOF_FirstModeRadioButton = QRadioButton(self.widget1)
...
"}")
        ...
        self.FCFV_SZOF_ZoomInOutLabel = QLabel(self.widget1)
        ...
        self.FCFV_SZOF_AlphaLabel = QLabel(self.widget1)
        ...
        self.FCFV_SZOF_SecondModeRadioButton = QRadioButton(self.widget1)
...
"}")
        ...
        self.FCFV_SZOF_RotateSpinBox = QSpinBox(self.widget1)
        ...
        self.FCFV_SZOF_RotateLabel = QLabel(self.widget1)
        ...
        self.FCFV_SZOF_LineYAxisOperationSeparator = QFrame(self.widget1)
        ...
        self.FCFV_SZOF_BetaLabel = QLabel(self.widget1)
...
class SetupMainApplication(QWidget):
